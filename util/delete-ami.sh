...
blueGroupAmi="'`/app/stakater/pipeline-library/util/read-from-yml.py ${DEPLOYMENT_STATE_FILE} ${PARENT_KEY_NODE}blue-group-ami-id`'"
greenGroupAmi="'`/app/stakater/pipeline-library/util/read-from-yml.py ${DEPLOYMENT_STATE_FILE} ${PARENT_KEY_NODE}green-group-ami-id`'"
