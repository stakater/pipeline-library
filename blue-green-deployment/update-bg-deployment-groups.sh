...
# Argument10: ACTIVE_ELB_CIDR_BLOCK
# Argument11: TEST_ELB_CIDR_BLOCK
#----------------------------------------------
...
IS_ELB_INTERNAL=$8
ENV_STATE_KEY=$9
ACTIVE_ELB_CIDR_BLOCK="${10}"
TEST_ELB_CIDR_BLOCK="${11}"
...
if test -z ${ACTIVE_ELB_CIDR_BLOCK};
then
   echo "Error: Value for ACTIVE_ELB_CIDR_BLOCK not defined.";
   ARE_BG_PARAMS_EMPTY=true;
fi;

if test -z ${TEST_ELB_CIDR_BLOCK};
then
   echo "Error: Value for TEST_ELB_CIDR_BLOCK not defined.";
   ARE_BG_PARAMS_EMPTY=true;
fi;
